...
function LongBiography() {
  ...
  return (
    <div
      className={`font-nunito mx-auto mb-6 max-w-3xl transform text-lg leading-relaxed font-bold text-balance text-gray-300 transition-all delay-700 duration-1000 md:mx-auto md:text-xl ${
